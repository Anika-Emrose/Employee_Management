            ...
            <div class="col-md-8">
                <div class="user-menu">
                    <ul>
                        ...
                        <li><a href="{{route('login')}}"><i class="fa fa-user"></i>Employee Login</a></li>
                    </ul>
                </div>
            </div>
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="./"><img src="{{asset('/')}}/assets/front-end/img/img.gif"style="height:70px ;width:300px" class="center"></a></h1>
                </div>
            </div>
